...
| xargs cp --parents -v -t ~/pages/docs/constydocs; find */src/ -path '*/docs/*' -name "*.png" | xargs cp --parents -v -t ~/pages/docs/constydocs; find */src/ -path '*/docs/*' -name "*.jpg" | xargs cp --parents -v -t ~/pages/docs/constydocs;
